...
from dataset.lazy_loader import LazyLoader, Celeba, W300DatasetLoader, W300Landmarks, W300LandmarksAugment, Cardio, \
    CardioLandmarks
...
enc_dec = StyleGanAutoEncoder(weights, load_style=True)
