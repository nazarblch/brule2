...
for i in range(100000):
    ...
    (
        ...
        l1_loss(fake_latent_pred, fake_latent) * 10
    ...
    WR.writable("cycle", sup_loss)(pred2["skeleton"], skeleton, pred2["mes"], measure).__mul__(10).minimize_step(
    ...
    WR.writable("cycle2", l1_loss)(restored, real_img).__mul__(200).minimize_step(
